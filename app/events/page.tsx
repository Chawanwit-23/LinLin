  ...
  return (
    <>
      ...
      <motion.div initial={{ opacity: 0, y: "100%" }} animate={{ opacity: 1, y: 0 }}
        ...
        <div className="bg-white w-full sm:max-w-md rounded-t-3xl sm:rounded-3xl shadow-2xl border border-pink-100 max-h-[92vh] overflow-y-auto" onClick={(e) => e.stopPropagation()}>
